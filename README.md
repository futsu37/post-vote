...
```
## Installation
#### The installation process will be changed to the one that uses pyproject.toml instead due to requirements.txt being deprecated in modern projects
...
## API (WILL BE REFACTORED DUE TO HARD READABILITY AND POOR ARCHITECTURE)
### user.py
```shell
...
Learn how to create readable and scalable backend applications, enhance and polish my current skills. Connect with a developer community. Show my dedication and learning abilities.
...
## Current me
I have more knowledge on how to write scalable backend applications than I used to. never worked in a team with other people. Have desire to connect with people to build projects and get better together.
