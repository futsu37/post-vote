...
from app.repository.user import create, get_by_email, get_by_username
from app.utils.exceptions.http.exc_409 import http_409_exc_username_request_conflict, http_409_exc_email_request_conflict
...
def create_user(user_create_form: UserCreate,db: Session) -> User:
  ...
  if get_by_email(db,new_user.email):
    raise http_409_exc_email_request_conflict()
