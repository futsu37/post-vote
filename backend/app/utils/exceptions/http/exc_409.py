...
def http_409_exc_profile_create_request_conflict() -> Exception:
  return HTTPException(status_code=status.HTTP_409_CONFLICT,
                                      detail=http_409_profile_create_conflict())